...
if version >= 700
  ...
  call s:HL('MatchParen', s:bg0, s:blue, s:bold)
endif
...
call s:HL('Search',    s:bg0, s:yellow, s:bold)
call s:HL('IncSearch', s:bg0, s:hls_cursor, s:bold)
...
if has("spell")
  if g:bu_ignore_capitalization == 1
    call s:HL('SpellCap', s:none, s:none)
  else
    " Not capitalised word, or compile warnings
    if g:gruvbox_improved_warnings == 0
      call s:HL('SpellCap',   s:none, s:none, s:undercurl, s:aqua)
    else
...
hi! link StartifySpecial GruvboxFg1
...
hi! link markdownRule GruvboxBlueBold
hi! link markdownHeadingRule GruvboxBlueBold
